    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              <a href="/admin/usuarios/cadastra_usuario" class="btn btn-success">Cadastrar Usuário</a>
            </div>
              ...
              <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/admin/usuarios/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                      
                      <a href="/admin/usuarios/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                  </tr>
                   <?php } ?> 
                </tbody>           
